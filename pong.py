...
class Pong:
    ...
    def texto_ganador(self, jugador):
        ...
        ganador = pygame.font.Font.render(mensaje, f'Ha ganado jugador {jugador}', True, cf._BLANCO)
    ...
    def bucle_principal(self):
        while True:
            ...
            if self.hay_ganador:
                self.pantalla.blit(self.ganador, (250, 250))
            else:
            ...
            pygame.draw.line(self.pantalla, cf._BLANCO, (cf.pantalla_centro_h, cf._PANTALLA_ALTURA), (cf.pantalla_centro_h, 0), cf.ANCHO_LINEA)
            pygame.display.flip()
